...
7. 非 Top 期刊论文可按与 Top 期刊相同的主题、证据和评分规则参与筛选。若原创研究的证据明确支持首次完整新通路、首次新产物路线、带明确数值的领域领先性能、经湿实验验证且可迁移的 AI 蛋白方法、或可推广的酶工程平台，可额外标记 exceptional_novelty=true；该标记是信息补充，不是非 Top 论文的准入前提。综述不得标记为创新例外。
